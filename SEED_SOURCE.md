...
**`eu_fdi_share`** (percent_of_total_FDI): 2016 → 78.0 (Σχεδ. 1.6, EXACT)
...
**⚠️ Το μεγαλύτερο κενό δεδομένων.** Η διπλωματική είναι πλούσια σε ποιοτική
στρατιωτική ανάλυση αλλά φτωχή σε αριθμούς:
